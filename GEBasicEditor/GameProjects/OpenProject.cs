...
namespace GEBasicEditor.GameProjects
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\GEBasicEditor\";
        ...
        private static void ReadProjectData()
        {
            ...
            {
                var allProjects = Serializer.FromFile<ProjectDataList>(_projectDataPath);
                if (allProjects == null)
                {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.GEBasic\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.GEBasic\Screenshot.png");
